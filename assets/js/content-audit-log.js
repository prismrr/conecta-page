window.ConectaContentAudit = {
  // Append-only audit stream for critical content changes.
  events: [
    {
    ...
    },
    {
      ...
      version: "v2026.1",
      author: "Time de Compliance",
      changeSummary: "Atualizacao de vigencia, changelog e transparência de cookies por categoria.",
      changeType: "revision"
    },
    {
